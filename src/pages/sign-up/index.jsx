...
export default function SignUp() {
  ...
  function doSignUp(e) {
    ...
    promise.then(() => { navigate('/sign-in'); setIsLoading(false); });
  ...
  return (
    <Container>
      ...
      <form onSubmit={doSignUp}>
        <Input type="text" value={name} disabled={isLoading} onChange={(e) => setName(e.target.value)} placeholder="Nome" required />
